...
namespace FarmSystem.Test1
{
    ...
    {
        //animal queue to hold animals and can be used by other pivate static methods in class
        private static Queue<FarmAnimal> AnimalQueue = new Queue<FarmAnimal>();
        private static EmydexFarmSystem farm = new EmydexFarmSystem();
...
***************************************************************************************************************/
        private static void Excercise1()
        {
            ...
            AnimalQueue.Enqueue(cow);
            AnimalQueue.Enqueue(hen);
            AnimalQueue.Enqueue(horse);
            AnimalQueue.Enqueue(sheep);
            farm.Enter(AnimalQueue);
            Console.ReadKey();
...
********************************************************************************************************************/
        private static void Excercise4()
        {
            ...
            Console.ReadKey();
            farm.FarmEmpty += EmptyFarmEventHandler;
            farm.ReleaseAllAnimals(AnimalQueue);
            Console.ReadKey();
        }

        //Event handler for when the queue has been emptied
        private static void EmptyFarmEventHandler(object sender, EventArgs e)
        {
